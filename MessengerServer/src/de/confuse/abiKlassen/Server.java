 ...
 * </p>
 * <p>
 * Klasse de.confuse.abiKlassen.Server
 * </p>
 * <p>
 * Objekte von Unterklassen der abstrakten Klasse de.confuse.abiKlassen.Server ermoeglichen das
 * Anbieten von Serverdiensten, so dass Clients Verbindungen zum de.confuse.abiKlassen.Server mittels
	...
	private class NewConnectionHandler extends Thread
	{
		...
		public void run()
		{
			while (active)
			{
				try
				{
					//Warten auf Verbdinungsversuch durch de.confuse.abiKlassen.Client:
					Socket clientSocket = serverSocket.accept();
					// Eingehende Nachrichten vom neu verbundenen de.confuse.abiKlassen.Client werden
				...
				{
					/*
					 * Kann keine Verbindung zum anfragenden de.confuse.abiKlassen.Client aufgebaut werden,
					 * geschieht nichts.
					 */
				}
			}
